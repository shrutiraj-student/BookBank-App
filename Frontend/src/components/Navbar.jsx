...
const Navbar = () => {
  ...
  return (
    <>
       <div className={` max-w-screen-2xl container dark:bg-slate-900 dark:text-white  fixed top-0 left-0 right-0 mx-auto md:px-20 px-4 z-50 ${
        sticky 
        ? "sticky-navbar shadow-md  duration-300 transition-all dark:bg-slate-600 dark:text-white ease-in-out bg-base-200 ":""
       }`}>
